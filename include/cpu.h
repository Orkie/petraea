...
// N
#define GET_NEGATIVE_FLAG(cpu) ((((pt_arm_cpu*)cpu)->cpsr >> 31)&0x1)
#define SET_NEGATIVE_FLAG(cpu, value) (((pt_arm_cpu*)cpu)->cpsr = ((((pt_arm_cpu*)cpu)->cpsr & (~(1<<31))) | (((value)&1)<<31)))

// Z
#define GET_ZERO_FLAG(cpu) ((((pt_arm_cpu*)cpu)->cpsr >> 30)&0x1)
#define SET_ZERO_FLAG(cpu, value) (((pt_arm_cpu*)cpu)->cpsr = ((((pt_arm_cpu*)cpu)->cpsr & (~(1<<30))) | (((value)&1)<<30)))

// C
#define GET_CARRY_FLAG(cpu) ((((pt_arm_cpu*)cpu)->cpsr >> 29)&0x1)
#define SET_CARRY_FLAG(cpu, value) (((pt_arm_cpu*)cpu)->cpsr = ((((pt_arm_cpu*)cpu)->cpsr & (~(1<<29))) | (((value)&1)<<29)))

// V
#define GET_OVERFLOW_FLAG(cpu) ((((pt_arm_cpu*)cpu)->cpsr >> 28)&0x1)
#define SET_OVERFLOW_FLAG(cpu, value) (((pt_arm_cpu*)cpu)->cpsr = ((((pt_arm_cpu*)cpu)->cpsr & (~(1<<28))) | (((value)&1)<<28)))

// T
#define GET_THUMB_FLAG(cpu) ((((pt_arm_cpu*)cpu)->cpsr >> 5)&0x1)
#define SET_THUMB_FLAG(cpu, value) (((pt_arm_cpu*)cpu)->cpsr = ((((pt_arm_cpu*)cpu)->cpsr & (~(1<<5))) | (((value)&1)<<5)))
